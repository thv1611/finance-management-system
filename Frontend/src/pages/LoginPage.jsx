...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setMessage("Login backend will be connected in the next task.");
  };
        ...
        <div className="flex items-center justify-center px-6 py-10 sm:px-10">
          <div className="w-full max-w-md rounded-[28px] bg-white/80 p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full rounded-full bg-gradient-to-r from-[#0f9b8e] to-[#6ee7c8] px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:opacity-95"
              >
                Sign In
              </button>
            </form>
