...
export default function AIInsightCard({
  ...
  return (
    <section className="rounded-lg bg-gradient-to-br from-[#0a8d86] via-[#1b7c98] to-[#2e5f8f] p-5 text-white shadow-[0_28px_58px_rgba(22,111,128,0.28)]">
      ...
      <p className="text-sm font-medium leading-6 text-white/88">{description}</p>
      {actionLabel && actionTo ? (
        <Link
          to={actionTo}
          className="mt-5 inline-flex rounded-lg bg-white/18 px-4 py-2.5 text-sm font-bold text-white shadow-[inset_0_0_0_1px_rgba(255,255,255,0.22)] transition hover:bg-white/25"
        >
          {actionLabel}
        </Link>
      ) : null}
